...
from keras.api.layers import GlobalAveragePooling2D, GlobalMaxPooling2D, Reshape, Dense
from keras.api.layers import multiply, Permute, Concatenate, Conv2D, Add, Activation, Lambda
from keras.api.layers import Dropout, MultiHeadAttention, LayerNormalization, Reshape
...
class MultiHeadAttention_LSA(keras.layers.MultiHeadAttention):
